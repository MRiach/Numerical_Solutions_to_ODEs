%This function computes the global error for the Explicit Method
%used in question 4 
function globalerror = ExplicitGlobalError(tinit,tfinal,initcond,h)

 globalerror = zeros(1,2);
 numsol = Explicit(tinit,tfinal,initcond,h);
